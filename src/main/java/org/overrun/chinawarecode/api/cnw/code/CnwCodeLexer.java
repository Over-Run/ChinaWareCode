...
public class CnwCodeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "BOOLEAN", "WS", "COMMENT", 
			"LINE_COMMENT", "INT", "LONG", "DOUBLE", "FLOAT", "NAME", "STRING", "FSTRING", 
			"EscapeSequence", "HexDigit", "LA", "RA", "END", "PLUS", "REDUCE", "RIDE", 
			"DIVIDE", "COMPARER", "MOVE", "LAMBDA"
		};
	}
	...
	public CnwCodeLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "CnwCode.g4"; }
