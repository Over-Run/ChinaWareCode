...
/**
 * This class provides an empty implementation of {@link CnwVisitor},
...
public class CnwBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements CnwVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
