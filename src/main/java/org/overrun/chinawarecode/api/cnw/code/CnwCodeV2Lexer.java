...
public class CnwCodeV2Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "WS", "COMMENT", "LINE_COMMENT", "BOOLEAN", "INT", 
			"LONG", "DOUBLE", "FLOAT", "NAME", "STRING", "FSTRING", "EscapeSequence", 
			"HexDigit", "BOOLEAN_CHARACTER"
		};
	}
	...
	public CnwCodeV2Lexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "CnwCodeV2.g4"; }
